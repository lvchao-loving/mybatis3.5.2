...
/**
 * Mapper.xml 对应的一个sql语句
 * 例如： <insert id="addUser" parameterType="User"> INSERT INTO `user` (`name`,`email`,`age`,`sex`,`schoolName`) VALUES (#{name},#{email},#{age},#{sex},#{schoolName}) </insert>
 */
public final class MappedStatement {
  // Mapper文件的磁盘路径
  private String resource;
  // 全局 configuration 配置文件
